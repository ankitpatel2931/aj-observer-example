...
To overload an Observer on Magento it's as usual, just add a preference in di.xml to overload our Observer. So edit the /app/code/VendorName/ModuleName/etc/di.xml file to add this line:

<preference for="VendorName\ModuleName\Observer\TestObserver" type="VendorName/ModuleName\Observer\SurchargeObserver" />

And create the Overload Observer object (/app/code/VendorName/ModuleName/Observer/SurchargeObserver.php) like this:
